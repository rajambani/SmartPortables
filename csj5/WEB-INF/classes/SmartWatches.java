...
public class SmartWatches extends HttpServlet 
{
  ...
  {  
	...
	List<Products> smartWatchList = fetchProductList.getSmartWatchList();
	...
	out.println("<article>");
	out.println("<h2>SMart Watches</h2>" +
				"<table>");
	...
	Products p;
	 for(int i = 0;i<smartWatchList.size();i++)
	{
		p = smartWatchList.get(i);
		...
		out.println("<tr>"+
					...
					"<input type='hidden' name='product' value='"+p+"'>" +
					"<input type='hidden' name='productCategory' value='SmartWatch'>" +
					"</form>" +
