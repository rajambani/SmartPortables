...
public class ExternalStorage extends HttpServlet 
{
  public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
  {  
	SAXParserDataStore fetchProductList = new SAXParserDataStore();
	List<Products> externalStorageList = fetchProductList.getExternalStorageList();
	...
	out.println("<article>");
	out.println("<h2>External Storage Devices</h2>" +
				"<table>");
	 ...
	 for(int i = 0;i<externalStorageList.size();i++)
	{
		...
		out.println("<tr>"+
					...
					"<input type='hidden' name='product' value='"+p+"'>" +
					"<input type='hidden' name='productCategory' value='ExternalStorage'>" +
					"</form>" +
